...
public class ScriptsController {
  ...
  public ResponseEntity<Page<List<ScriptInfoForList>>> getScriptListPage(
    ...
    logger.info("Script list request received. " + parameters, page, pageSize, status, nameContains,
    ...
    Page<List<ScriptInfoForList>> scriptPage = convertListToPage(scriptList, page, pageSize, status,
        nameContains, orderByName, reverseOrder);
    logger.info("Script list request successfully processed. " + parameters, page, pageSize, status,
        nameContains, orderByName, reverseOrder);
