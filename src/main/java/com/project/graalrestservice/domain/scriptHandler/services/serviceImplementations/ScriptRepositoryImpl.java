...
public class ScriptRepositoryImpl implements ScriptRepository {
     ...
     * @param script
     *            script info, contains all the information about the script
     * 
     * @throws WrongNameException
     *             if a script with this name already exists
     */
    @Override
     ...
     *             if page or pageSize less than 1. Also discarded if the list is empty for a given page
     */
    @Override
    public List<Script> getScriptList(ScriptStatus scriptStatus, String nameContains) {
        ...
        logger.trace("Script repository return filtered script list. Parameters [scriptStatus={}, nameContains={}]",
